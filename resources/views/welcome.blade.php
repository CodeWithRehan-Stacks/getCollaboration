...
<head>
    ...
    <style>
        ...
        .hero-glow {
            background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(139, 92, 246, 0.28), transparent);
        }
...
<body class="bg-[#05070c] text-white antialiased overflow-x-hidden">

    <!-- Background Animated Blobs -->
    <div class="fixed inset-0 pointer-events-none z-0">
        <div class="blob absolute top-[-10%] left-[-5%] w-[600px] h-[600px] bg-purple-600/15 rounded-full"></div>
        <div class="blob absolute top-[40%] right-[-10%] w-[500px] h-[500px] bg-blue-500/10 rounded-full" style="animation-delay: 2s;"></div>
        <div class="blob absolute bottom-[-10%] left-[20%] w-[450px] h-[450px] bg-emerald-500/5 rounded-full" style="animation-delay: 4s;"></div>
    </div>

    <!-- Header / Navigation -->
    <header class="relative z-50 border-b border-white/5 bg-[#05070c]/60 backdrop-blur-md">
        <div class="max-w-7xl mx-auto flex items-center justify-between px-6 md:px-12 py-5">
            <div class="flex items-center gap-3 group cursor-pointer">
                <div class="w-9 h-9 bg-gradient-to-br from-purple-500 to-blue-600 rounded-xl flex items-center justify-center shadow-md transition-transform group-hover:scale-105">
                ...
                <span class="text-xl font-extrabold tracking-tight bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">GetCollaboration</span>
            </div>
                ...
                @if(Route::has('login'))
                    ...
                    @else
                        ...
                        @if(Route::has('register'))
                            <a href="{{ route('register') }}" class="btn-primary px-5 py-2.5 text-sm font-semibold text-white rounded-xl shadow-md">
    ...
    <main class="relative z-10">
        ...
        <section class="hero-glow text-center px-6 pt-28 pb-24 max-w-5xl mx-auto">
            <div class="inline-flex items-center gap-2 px-4 py-2 glass rounded-full text-xs md:text-sm text-purple-300 mb-8 font-medium tracking-wide shadow-inner border border-purple-500/20">
            ...
            <h1 class="text-5xl md:text-8xl font-black tracking-tight leading-[1.02] mb-6">
                Where <span class="gradient-text">Creators</span><br class="hidden md:block"> Meet <span class="gradient-text">Investors</span>
            </h1>

            <p class="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-12 leading-relaxed font-normal">
                An intelligent ecosystem built to bridge the gap. Our system auto-matches content creators with targeted businesses based on precise niches, unlocking instant growth.
            </p>

            <div class="flex flex-col sm:flex-row items-center justify-center gap-5">
                @if(Route::has('register'))
                    <a href="{{ route('register') }}" class="btn-primary w-full sm:w-auto px-8 py-4 font-bold text-white rounded-xl text-base shadow-xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mt-24 px-4">
                ...
                <div class="p-6 glass rounded-2xl border border-white/5">
                    ...
                    <div class="text-xs tracking-wider uppercase text-gray-500 font-semibold mt-2">Creator & Investor Roles</div>
                </div>
                <div class="p-6 glass rounded-2xl border border-white/5">
        ...
        <section class="px-6 md:px-16 py-24 max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Feature 1: Matching Based on 15325.jpg Logic -->
                <div class="feature-card glass-premium rounded-2xl p-8 flex flex-col justify-between">
                    <div>
                        <div class="w-12 h-12 bg-purple-500/10 border border-purple-500/20 rounded-xl flex items-center justify-center mb-6 shadow-inner">
                        ...
                        <p class="text-gray-400 text-sm leading-relaxed">Our system scans profiles. When a business category aligns with a creator's exact niche and sub-niche, a direct match is generated automatically.</p>
                    </div>
                </div>
                ...
                <div class="feature-card glass-premium rounded-2xl p-8 flex flex-col justify-between">
                    <div>
                        <div class="w-12 h-12 bg-blue-500/10 border border-blue-500/20 rounded-xl flex items-center justify-center mb-6 shadow-inner">
                ...
                <div class="feature-card glass-premium rounded-2xl p-8 flex flex-col justify-between">
                    <div>
                        <div class="w-12 h-12 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center justify-center mb-6 shadow-inner">
        ...
        <section class="px-6 md:px-16 py-20 max-w-6xl mx-auto border-t border-white/5">
            <div class="text-center mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center relative">
                @foreach([
                    ['1', 'Authenticate & Choose Role', 'Sign up safely. Select either Creator or Investor. Admins are strictly managed on the backend dashboard.', 'from-purple-500 to-indigo-600'],
                    ['2', 'Fill Niche Information', 'Provide your core categories and profiles. Perfect data alignments yield high-converting matches.', 'from-blue-500 to-indigo-600'],
                    ['3', 'Match, Chat & Collaborate', 'Review your tailored recommendation list. Chat directly with targets to finalize actionable contracts.', 'from-emerald-500 to-teal-600'],
                ] as [$num, $title, $desc, $gradient])
                <div class="flex flex-col items-center p-6 bg-white/[0.01] border border-white/5 rounded-2xl shadow-sm hover:bg-white/[0.02] transition">
                    <div class="w-14 h-14 bg-gradient-to-br {{ $gradient }} rounded-2xl flex items-center justify-center text-xl font-black shadow-lg mb-5 text-white">
                        {{ $num }}
                    </div>
        ...
        <section class="px-6 py-24 text-center max-w-5xl mx-auto">
            <div class="glass-premium rounded-3xl px-8 py-16 border border-purple-500/10 shadow-2xl relative overflow-hidden">
                ...
                @if(Route::has('register'))
                    <a href="{{ route('register') }}" class="btn-primary inline-block px-10 py-4 font-bold text-white rounded-xl text-base shadow-xl">
    ...
    <!-- Footer -->
    <footer class="text-center py-10 border-t border-white/5 text-gray-500 text-sm font-medium tracking-wide">
